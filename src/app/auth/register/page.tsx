...
export default function Register() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // Use our custom registration API route
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-100 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-1">Join SleepDiary to track and improve your sleep</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3 pt-2">
            ...
            <Link href="/api/auth/signin/google" className="w-full bg-white text-gray-800 border border-gray-300 py-2 px-4 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors flex items-center justify-center">
